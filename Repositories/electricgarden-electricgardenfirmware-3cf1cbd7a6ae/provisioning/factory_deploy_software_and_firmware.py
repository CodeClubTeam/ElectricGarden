...
esptool_flash_wr = ('-b', '921600', 'write_flash', '-z', '--flash_mode', 'dio', '--flash_freq', '80m', '--flash_size', 'detect')
...
# esptool.py --chip esp32 --port COM4 --baud 115200 write_flash 0x1000 bootloader.bin -fs 4MB -z
# esptool.py --chip esp32 --port COM4 --baud 115200 write_flash 0x8000 partitions.bin -fs 4MB -z
# esptool.py --chip esp32 --port COM4 --baud 115200 write_flash 0x10000 appimg.bin -fs 4MB -z
...
def main(arguments=None):
    ...
    parser.add_argument('-r', '--rom', required=False, type=str, help='Firmware ROM Image to program', default=None)
