...
def crc16(data):
    """Calculates CRC16 value from the default implementation
    `data`      - data for calculating CRC, must be bytes 
    Return calculated value of CRC
    An initial value of 0xFFFF is used.
    Use this function for future compatibility sake.
    """
    # Initial value to match brush:lib/crc16.py initial value. 
    return crc16xmodem(data, crc=0xFFFF)