...
class FRAM_I2C(FRAM):
    ...
    def save_reading(self, reading, no_save):
        ...
        reading_address = 0x100 + (counter * 70)
        max_address = 0x1FC3
        min_address = 0x30
    ...
    def grab_reading(self):
        ...
        reading_address = 0x100 + (int(counter) * 70)
        max_address = 0x1FC3
        min_address = 0x30
        act_address = reading_address % 0x2000
        if act_address > max_address or act_address < min_address:
            ...
            value = 3
        return self.read_address(reading_address, 70).decode("utf-8").strip('\x00'), value
