...
class LTE_setup:
    ...
    def send(self, s1, s2, s3, s4, s5, s6, s7, s8):
        ...
        if self.fram.check_device_hq():
            ...
            response = urequests.get('http://device-hq.myelectricgarden.com/api/device-settings/v1/' + serial)
    ...
    def deinitialise(self):
        ...
        #self.lte.send_at_cmd('AT+CPSMS=1,,,"10100001","00000011"') # AT command to set up PSM for 10 minute interval + 20 min active time
        sleep_ms(200)
