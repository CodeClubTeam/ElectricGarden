...
import { OrganisationIdSelectorField } from '../../Organisation';
...
interface SensorAssignProps extends ModalProps {
    sensor: ServerSensor;
}

export const SensorAssign: React.FC<SensorAssignProps> = ({
    sensor,
    show,
    onClose,
}) => {
            ...
            formikConfig={{
                ...
                render: (form) => (
                    <>
                        ...
                        <label>
                            Organisation
                            <Field name="organisationId" id="organisationId">
                                {(props: any) => (
                                    <OrganisationIdSelectorField
                                        {...props}
                                        placeholder="None selected (unassign)"
                                        clearable
                                    />
                                )}
                            </Field>
