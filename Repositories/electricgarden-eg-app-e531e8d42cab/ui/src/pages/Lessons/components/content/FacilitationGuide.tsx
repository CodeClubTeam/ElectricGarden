...
import { getFacilitationGuideByName } from '../../../../lessons/components/facilitationGuides';
...
export const FacilitationGuide: React.FC = () => {
    const { name } = useParams<{ name: string }>();
    const guide = getFacilitationGuideByName(name);
    if (!guide) {
