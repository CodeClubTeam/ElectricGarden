...
_stripe_3d_secure_create()
{
    ...
    flags+=("--livemode")
    local_nonpersistent_flags+=("--livemode")
    flags+=("--return-url=")
...
_stripe_bitcoin_receivers_list()
{
    last_command="stripe_bitcoin_receivers_list"
...
_stripe_bitcoin_receivers_retrieve()
{
    last_command="stripe_bitcoin_receivers_retrieve"
...
_stripe_bitcoin_receivers()
{
    last_command="stripe_bitcoin_receivers"
...
_stripe_bitcoin_transactions_list()
{
    last_command="stripe_bitcoin_transactions_list"
...
_stripe_bitcoin_transactions()
{
    last_command="stripe_bitcoin_transactions"
...
_stripe_config()
{
    ...
    local_nonpersistent_flags+=("--set string string")
    flags+=("--unset=")
...
_stripe_customers_create()
{
    ...
    flags+=("--account-balance=")
    two_word_flags+=("--account-balance")
    local_nonpersistent_flags+=("--account-balance=")
    flags+=("--balance=")
...
_stripe_invoices_create()
{
    ...
    local_nonpersistent_flags+=("--application-fee-amount=")
    flags+=("--billing=")
    two_word_flags+=("--billing")
    local_nonpersistent_flags+=("--billing=")
...
_stripe_issuer_fraud_records_list()
{
    last_command="stripe_issuer_fraud_records_list"
...
_stripe_issuer_fraud_records_retrieve()
{
    last_command="stripe_issuer_fraud_records_retrieve"
...
_stripe_issuer_fraud_records()
{
    last_command="stripe_issuer_fraud_records"
...
_stripe_issuing_authorizations_approve()
{
    ...
    local_nonpersistent_flags+=("--expand=")
    flags+=("--held-amount=")
    two_word_flags+=("--held-amount")
    local_nonpersistent_flags+=("--held-amount=")
    flags+=("--idempotency=")
    two_word_flags+=("--idempotency")
    two_word_flags+=("-i")
    local_nonpersistent_flags+=("--idempotency=")
...
_stripe_issuing_cards_details()
{
    last_command="stripe_issuing_cards_details"
...
_stripe_issuing_disputes_create()
{
    ...
    two_word_flags+=("-d")
    local_nonpersistent_flags+=("--data=")
    flags+=("--disputed-transaction=")
    two_word_flags+=("--disputed-transaction")
    local_nonpersistent_flags+=("--disputed-transaction=")
    flags+=("--expand=")
    two_word_flags+=("--expand")
    two_word_flags+=("-e")
    local_nonpersistent_flags+=("--expand=")
...
_stripe_recipients_create()
{
    last_command="stripe_recipients_create"
    ...
    flags+=("--bank-account=")
    two_word_flags+=("--bank-account")
    local_nonpersistent_flags+=("--bank-account=")
    flags+=("--card=")
    two_word_flags+=("--card")
    local_nonpersistent_flags+=("--card=")
    flags+=("--confirm")
    ...
    local_nonpersistent_flags+=("--stripe-version=")
    flags+=("--tax-id=")
    two_word_flags+=("--tax-id")
    local_nonpersistent_flags+=("--tax-id=")
    flags+=("--type=")
    two_word_flags+=("--type")
    local_nonpersistent_flags+=("--type=")
    flags+=("--api-key=")
...
_stripe_recipients_delete()
{
    last_command="stripe_recipients_delete"
...
_stripe_recipients_list()
{
    last_command="stripe_recipients_list"
...
_stripe_recipients_retrieve()
{
    last_command="stripe_recipients_retrieve"
...
_stripe_recipients_update()
{
    last_command="stripe_recipients_update"
    ...
    local_nonpersistent_flags+=("--data=")
    flags+=("--default-card=")
    two_word_flags+=("--default-card")
    local_nonpersistent_flags+=("--default-card=")
    flags+=("--description=")
    two_word_flags+=("--description")
    local_nonpersistent_flags+=("--description=")
    flags+=("--email=")
...
_stripe_recipients()
{
    last_command="stripe_recipients"
...
_stripe_samples_create()
{
    ...
    must_have_one_flag=()
    must_have_one_noun=()
    must_have_one_noun+=("adding-sales-tax")
    must_have_one_noun+=("checkout-one-time-payments")
    must_have_one_noun+=("checkout-single-subscription")
    must_have_one_noun+=("checkout-subscription-and-add-on")
    must_have_one_noun+=("payment-form-modal")
    must_have_one_noun+=("placing-a-hold")
    must_have_one_noun+=("react-elements-card-payment")
    must_have_one_noun+=("saving-card-after-payment")
    must_have_one_noun+=("saving-card-without-payment")
    must_have_one_noun+=("web-elements-card-payment")
    noun_aliases=()
}

_stripe_samples_fixtures()
{
    last_command="stripe_samples_fixtures"
...
_stripe_subscription_schedules_create()
{
    ...
    flags+=("--livemode")
    local_nonpersistent_flags+=("--livemode")
    flags+=("--renewal-behavior=")
    two_word_flags+=("--renewal-behavior")
    local_nonpersistent_flags+=("--renewal-behavior=")
    flags+=("--show-headers")
    flags+=("-s")
    local_nonpersistent_flags+=("--show-headers")
    flags+=("--stripe-account=")
...
_stripe_terminal_connection_tokens_create()
{
    ...
    flags+=("--operator-account=")
    two_word_flags+=("--operator-account")
    local_nonpersistent_flags+=("--operator-account=")
    flags+=("--show-headers")
    flags+=("-s")
    local_nonpersistent_flags+=("--show-headers")
    flags+=("--stripe-account=")
...
_stripe_root_command()
{
    ...
    commands+=("bitcoin_receivers")
    commands+=("bitcoin_transactions")
    commands+=("capabilities")
    commands+=("cards")
    commands+=("charges")
    commands+=("checkout")
